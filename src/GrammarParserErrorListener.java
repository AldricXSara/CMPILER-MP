...
public class GrammarParserErrorListener implements ANTLRErrorListener{
	
	ArrayList<String> errors;
	
	public GrammarParserErrorListener(ArrayList<String> errors){
		this.errors = errors;
	}
...
/*			System.err.println
			...
			errors.add(errorType + " Line " + errorLine + ": " + errorMsg);
		...
		System.err.println(errorType + " " + errorLine + " " + errorMsg);
	}
